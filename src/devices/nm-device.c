                            ...
                            gboolean commit)
{
	...
	gboolean default_route_remove_all = FALSE;
	...
	default_route_remove_all = FALSE;
...
END_ADD_DEFAULT_ROUTE:
	if (default_route_remove_all)
		nm_ip4_config_default_routes_remove_all (composite);
...
END_ADD_DEFAULT_ROUTE:
	if (default_route_remove_all)
		nm_ip6_config_default_routes_remove_all (composite);
